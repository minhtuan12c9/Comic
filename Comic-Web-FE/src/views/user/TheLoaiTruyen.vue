    ...
    <main id="" class="main" style="margin-top: 32px; margin-left: 380px; margin-right: 380px">
      <div class="truyenmoicapnhat">
        ...
        <div class="d-flex flex-wrap" style="gap: 10px">
          <!-- item -->
          <div data-aos="zoom-in" class="card mb-0" v-for="story in category.stories" :key="story.id">
  ...
  methods: {
    async ShowCategory() {
      try {
        ...
        let response = await axios.get(`http://localhost:8000/api/story-category/${this.categoryId}/story`);
